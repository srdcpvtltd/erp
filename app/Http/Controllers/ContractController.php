    ...
    public function index()
    {
        if(\Auth::user()->can('manage contract'))
        {
            ...
            if(\Auth::user()->type=='company')
            {
                ...
                $contracts   = Contract::where('created_by', '=', \Auth::user()->creatorId())->with(['clients','types','projects'])->get();
            ...
            {
                $contracts   = Contract::where('client_name', '=', \Auth::user()->id)->with(['clients','types','projects'])->get();
