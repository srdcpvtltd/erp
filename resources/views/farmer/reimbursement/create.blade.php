...
@section('page-title')
    {{__('Farming Reimbursement Create')}}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item"><a href="{{route('farmer.reimbursement.index')}}">{{__('Farming Reimbursement')}}</a></li>
    <li class="breadcrumb-item">{{__('Farming Reimbursement Create')}}</li>
@endsection
@push('script-page')
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {{ Form::text('type',  'Reimbursement', array('class' => 'form-control','required'=>'required','readonly'=>'true')) }}
                        </div>
                        <div class="form-group col-md-6">
