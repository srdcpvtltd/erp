    ...
    <div class="card">
        <div class="card-body">
            ...
            <dl class="row mb-0 align-items-center">
                ...
                <dd class="col-sm-7 text-sm">{{!empty($interviewSchedule->applications) ? !empty($interviewSchedule->applications->jobs) ? $interviewSchedule->applications->jobs->title : '-' : '-'}}</dd>
                <dt class="col-sm-5 h6 text-sm">{{__('Interview On')}}</dt>
                <dd class="col-sm-7 text-sm"> {{  \Auth::user()->dateFormat($interviewSchedule->date).' '. \Auth::user()->timeFormat($interviewSchedule->time) }}</dd>
                <dt class="col-sm-5 h6 text-sm">{{__('Assign Employee')}}</dt>
                <dd class="col-sm-7 text-sm">{{!empty($interviewSchedule->users)?$interviewSchedule->users->name:'-'}}</dd>
            </dl>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            ...
            <dl class="row mb-0 align-items-center">
                ...
                <dd class="col-sm-7 text-sm">{{($interviewSchedule->applications)?$interviewSchedule->applications->name:'-'}}</dd>
                <dt class="col-sm-5 h6 text-sm">{{__('Email')}}</dt>
                <dd class="col-sm-7 text-sm"> {{($interviewSchedule->applications)?$interviewSchedule->applications->email:'-'}}</dd>
                <dt class="col-sm-5 h6 text-sm">{{__('Phone')}}</dt>
                <dd class="col-sm-7 text-sm">{{($interviewSchedule->applications)?$interviewSchedule->applications->phone:'-'}}</dd>
            </dl>
        </div>
    </div>
    <div class="card">
