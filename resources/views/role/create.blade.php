    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
               ...
               <li class="nav-item">
                    <a class="nav-link" id="pills-crm-tab" data-bs-toggle="pill" href="#farmer" role="tab" aria-controls="pills-profile" aria-selected="false">{{__('Farmer Management')}}</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="crm" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @php
                        $modules=['crm dashboard','lead','pipeline','lead stage','source','label','deal','stage','task','form builder','form response','contract','contract type','farmer registration','farmer guarantor','farmer security deposit'];
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
                                            ...
                                            <td>
                                                <div class="row ">
                                                    ...
                                                    @if ($key = array_search('statement ' . $module, $permissions))
                                                        <div class="col-md-3 custom-control custom-checkbox">
                                                            {{ Form::checkbox('permissions[]', $key, false, ['class' => 'form-check-input isscheck account_checkall isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key]) }}
                                                            {{ Form::label('permission' . $key, 'Statement', ['class' => 'custom-control-label']) }}<br>
                                                        </div>
                                                    @endif
                                                @endif
                                                @if (in_array('stock ' . $module, (array) $permissions))
                                                    @if ($key = array_search('stock ' . $module, $permissions))
                                                        <div class="col-md-3 custom-control custom-checkbox">
                                                            {{ Form::checkbox('permissions[]', $key, false, ['class' => 'form-check-input isscheck account_checkall isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key]) }}
                                                            {{ Form::label('permission' . $key, 'Stock', ['class' => 'custom-control-label']) }}<br>
                                                        </div>
                                                    @endif
                                                @endif
                                                    @if(in_array('income vs expense '.$module,(array) $permissions))
                ...
                <div class="tab-pane fade" id="farmer" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @php
                        $modules=['farmer registration','farmer guarantor','farmer security deposit'];
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
                                <h6 class="my-3">{{__('Assign Farmer related Permission to Roles')}}</h6>
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    <thead>
                                    <tr>
                                        <th>
                ...
                <div class="tab-pane fade" id="pos" role="tabpanel" aria-labelledby="pills-contact-tab">
                    @php
                        $modules=['warehouse','purchase','pos','barcode' , 'print settings'];
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
